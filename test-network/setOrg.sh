...
echo "  1) Org1 - Broker        (localhost:7051)"
echo "  2) Org2 - Lender        (localhost:9051)"
echo "  3) Org3 - Conveyancer   (localhost:11051)"
echo "  4) Org4 - Estate Agent  (localhost:11061)"
echo ""
